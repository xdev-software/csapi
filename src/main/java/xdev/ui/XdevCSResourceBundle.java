...
/**
 * Helper class for component suite resource bundle.
 * 
 * @author XDEV Software
 * 
 */
public class XdevCSResourceBundle
{
	/**
	 * serialVersionUID.
	 */
	...
	private static ResourceBundle getBundle()
	{
		...
		{
			resourceBundle = ResourceBundle.getBundle(XdevCSResourceBundle.class.getPackage()
					.getName() + BUNDLE_NAME);
		}
	 ...
	 * @param args
	 *            optional values to replace the placeholders with
	 * @return a String
	 */
