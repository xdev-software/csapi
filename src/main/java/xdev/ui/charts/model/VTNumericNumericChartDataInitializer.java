 ...
 * @since 4.0
 */
public class VTNumericNumericChartDataInitializer extends VirtualTableAdapter implements
		ChartDataInitializer<VirtualTable, VirtualTableColumn<?>>
{
	// data ranges
	/**
	 * the categories stored in a {@link NumericRange}.
	 */
	 ...
	 * </p>
	 */
	public VTNumericNumericChartDataInitializer()
	{
		super();
	}
				...
				currentSeriesModel.addPoint(orientation.getOrientedPoint(
						new RealPosition(ChartRangeComputationUtils.getRangeValue(
								this.categoryRange,container.getValueAt(row,this.categoryColumn)
										.doubleValue())),new RealPosition(value.doubleValue())));
			}
